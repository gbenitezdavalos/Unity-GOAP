...
public class BeliefFactory {
    // Use MonoBehaviour so both GoapAgent and other agents (e.g., WorkerAgent) can share this helper.
    readonly MonoBehaviour agent;
    readonly Dictionary<string, AgentBelief> beliefs;
    
    public BeliefFactory(MonoBehaviour agent, Dictionary<string, AgentBelief> beliefs) {
        this.agent = agent;
