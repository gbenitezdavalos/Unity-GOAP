...
public interface IGoapPlanner {
    ActionPlan Plan(HashSet<AgentAction> actions, HashSet<AgentGoal> goals, AgentGoal mostRecentGoal = null);
}

public class GoapPlanner : IGoapPlanner {
    public ActionPlan Plan(HashSet<AgentAction> actions, HashSet<AgentGoal> goals, AgentGoal mostRecentGoal = null) {
